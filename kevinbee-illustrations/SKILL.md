...
默认视觉 IP 是“凯冰”：白帽红星、冰蓝短发、猩红斗篷和黑色战斗服的 Q 版日系少女。凯冰以冷静、坚定的姿态亲手操作低科技荒诞装置，必须参与画面的核心动作，不能只是站在旁边当装饰或被画成角色海报。
...
不要复刻过往案例。案例只提供风格密度和凯冰参与方式，不能直接复用已有案例构图，除非用户明确要求复刻某张图。每次都要从当前文章重新发明一个奇怪但成立的隐喻。
