...
```text
Use $kevinbee-illustrations 给这篇长文做配图策略。
...
```text
Use $kevinbee-illustrations 为“把一条原始素材加工成流量、信任、转化三种内容”生成一张图。
不要画正式流程图，不要复刻一鱼多吃旧案例。
请重新发明一个新的低科技隐喻，让凯冰参与核心动作。
```

## 改图：去掉标题

```text
Use $kevinbee-illustrations 帮我编辑这张图。
...
```text
Use $kevinbee-illustrations 这张图方向对，但凯冰有点像装饰。
请保持核心意思不变，重生成一版：让凯冰成为真正推动结构运转的人，并保留白帽红星。
画面更怪一点，但仍然纯白、清爽、少字。
```
...
```text
Use $kevinbee-illustrations 输出 5 个不同主题的凯冰正文配图效果。
