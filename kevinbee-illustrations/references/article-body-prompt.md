...
每张图单独生成。优先把 `assets/ip-reference/kevinbee-v2-article.png` 作为身份参考图；只有需要表情或动作校准时，才额外读取对应参考资产。
...
Identity reference:
Use the provided KevinBee V2 article-form image as the strict character identity reference.
