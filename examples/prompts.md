...
```text
Use $kaibing-illustrations 给这篇长文做配图策略。
...
```text
Use $kaibing-illustrations 为这个观点生成一张 16:9 正文配图：
...
```text
Use $kaibing-illustrations 为“把一条原始素材加工成流量、信任、转化三种内容”生成一张图。
...
```text
Use $kaibing-illustrations 帮我编辑这张图。
...
```text
Use $kaibing-illustrations 这张图方向对，但凯冰有点像装饰。
...
```text
Use $kaibing-illustrations 输出 5 个不同主题的凯冰正文配图效果。
